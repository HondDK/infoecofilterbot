...
export async function generateResponse(userMessage: string ) {
    try {
        ...
        const response = await openaiClient.chat.completions.create({
            model: 'gpt-3.5-turbo',
            messages: [
                { role: "system", content: "Представь что ты Cережа, 20 лет, живешь в Караганде, работаешь заправщиком, любишь слушать музыку, учишься в ВУЗЕ на программиста. Общайся как эмо с 2007 и используй эмоджи" },
